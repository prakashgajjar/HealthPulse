    ...
    <div className="">
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 rounded-lg border border-dashed border-emerald-300 bg-emerald-50 p-4">
            ...
            <p className="mt-2 text-xs text-gray-500">
              *These credentials are provided for evaluation and demo purposes
              only.
            </p>
          </div>
        </div>
      </div>
      {/* Demo Credentials (For Interview/Test Purpose) */}
    </div>
  );
}
